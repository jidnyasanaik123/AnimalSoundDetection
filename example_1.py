...
# User input for the number of characteristics (1 to 20)
num_characteristics = st.number_input(
    "Enter the number of characteristics (1 to 20):", 
    min_value=1, max_value=20, value=5, step=1, key="num_characteristics"
)
...
if st.session_state["show_characteristics"]:
    all_characteristics = [
        ...
        "Cows are herbivores.",
        "They spend around 8 hours grazing daily.",
        "Cows produce methane during digestion.",
        "The average cow weighs about 1,200 pounds.",
        "Cows have 32 teeth.",
        "A group of cows is called a herd.",
        "Cows have panoramic vision.",
        "Cows have a strong bond with their calves.",
        "They can drink up to 50 gallons of water a day.",
        "Cows are social and curious animals."
    ]

    selected_characteristics = all_characteristics[:num_characteristics]
